...
<body>
    ...
    <div class="breadcumb-area height-700 bg-img bg-overlay" style="background-image: url(img/bg-img/Gift.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="single-listing-content">
                        ...
                        for(int i =0; i<l; i++){
                            rs = st.executeQuery("Select * from offers where ID = "+(i+1)+"");
                            if(rs.next()){
