		...
		<div class="container-login100" id="custom-container">
			<div class="wrap-login100" id="custom-login">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input type="text" class="input100"  name="event">
                                                
						<span class="focus-input100" data-placeholder="Name of the Event"></span>
					</div>
                                        
                                        <input type="hidden" name="uploader" value="<%=name%>">
                                        
                                        <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<select name="category" id="" class="input100" placeholder="Category">
                                                                            <option value="Other">Category</option>
                                                                            <option value="Party">Party</option>
                                                                            <option value="2">Traditional Event</option>
						...
						<span class="focus-input100" ></span>
                                        ...
                                        <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input type="text" class="input100" name="conduct">
						<span class="focus-input100" data-placeholder="Conducted By"></span>
					</div>
                                        
                                        <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input type="date" class="input100" name="dateE">
						<span class="focus-input100" ></span>
					</div>
                                        
                                        <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input type="time" class="input100" name="timeE">
						<span class="focus-input100" ></span>
					</div>
                                        
                                        <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input type="text" class="input100" name="place">
						<span class="focus-input100" data-placeholder="Venue"></span>
					</div>
                                        
                                        <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<textarea  id="" cols="30" rows="7" class="input100"  name="description"></textarea>
						<span class="focus-input100" data-placeholder="Description about Item"></span>
					</div>
