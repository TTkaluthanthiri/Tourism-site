...
public class ContactUS extends HttpServlet {
    ...
    if(url.endsWith("contact.jsp")){
        ...
        try{
            ...
            st.executeUpdate("Insert into contact_site(Title, Description, Sender, Email) values('"+title+"','"+desc+"','"+send+"', '"+email+"' )");
            out.println("Entered");
        ...
        //int amount = Integer.parseInt(qua);
        ...
        try{
            ...
            st = con.createStatement();
            //out.println("Entered"+name+desc+send+receive);
            st.executeUpdate("Insert into contact_messages(Title, Description, Sender, Receiver, Item_ID, Amount, Email) values('"+title+"','"+desc+"','"+send+"', '"+receive+"', "+ID+", "+(1)+", '"+email+"' )");
            out.println("Entered");
